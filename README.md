...
haneul seed 엔진(imitated seed 엔진의 경우 호환성 모드 제공됨) 위키에서의 반달을 자동 감지하고 차단합니다. 반달성 문서 삭제 및 휴지통화 등의 후속 조치도 자동으로 진행됩니다.
...
# 필요한 권한
어차피 예외 처리가 되어 있어 권한이 부족하면 해당 작업은 건너뛰기 때문에 권한 부족으로 오류가 발생할 일은 드뭅니다. 다만 아직까지는 api_access가 필수적으로 필요합니다.
